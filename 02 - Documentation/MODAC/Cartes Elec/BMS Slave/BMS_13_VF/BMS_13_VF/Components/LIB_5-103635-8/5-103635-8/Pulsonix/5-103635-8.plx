...
(library Library_1
	...
	(patternDef "SHDRRA9W69P0X254_1X9_2527X1359" (originalName "SHDRRA9W69P0X254_1X9_2527X1359")
		...
		(layerContents (layerNumRef 28)
			(line (pt 2.475 -1.02) (pt -22.795 -1.02) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -22.795 -1.02) (pt -22.795 12.77) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -22.795 12.77) (pt 2.475 12.77) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 2.475 12.77) (pt 2.475 -1.02) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "5-103635-8" (originalName "5-103635-8") (compHeader (numPins 9) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://www.te.com/commerce/DocumentDelivery/DDEController?Action=srchrtrv&DocNm=4-1773458-0_AMPMODU_MTE_INTERCONNECT_SYS&DocType=Data%20Sheet&DocLang=English&PartCntxt=5-103635-8&DocFormat=pdf")
		(attr "<Component Height>" "7.41")
		(attr "<STEP Filename>" "5-103635-8.stp")
		(attr "<STEP Offsets>" "X=-10.16;Y=12.67;Z=2.53")
